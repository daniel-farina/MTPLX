...
[![Status](https://img.shields.io/badge/status-v0.3.3-blue)](CHANGELOG.md)
...
- **v0.3.3 status: compatibility and streaming-tools patch release**, preserving the v0.3.2 OpenCode/Sustained defaults while adding Android Studio request-shape tolerance, OpenAI-shaped errors, incremental Qwen XML tool-call streaming, and removing hidden Pi output caps.
